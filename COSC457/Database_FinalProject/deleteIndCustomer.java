...
public class deleteIndCustomer {
    
    public deleteIndCustomer(){
    ...
    private static void placeComponents(JPanel panel) {
	    ...
	    CustomerID.setBounds(280,10,100,25);
            ...
            JLabel CustomerLPLabel = new JLabel("License Plate # of Customer to be Deleted: ");
            CustomerLPLabel.setBounds(50, 50, 275, 25);
            panel.add(CustomerLPLabel);
             
            JTextField CustomerLP = new JTextField(20);
	    CustomerLP.setBounds(280,50,100,25);
            panel.add(CustomerLP);
            
	    
	    JButton DeleteCustomerButton = new JButton("Delete Customer");
	    DeleteCustomerButton.setBounds(120, 90, 150, 25);
	    ...
	    DeleteCustomerButton.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
                            ...
                            if (command.equals("Delete Customer")){	
                                ...
                                int r = stmt.executeUpdate("delete from INDIVIDUAL_CUSTOMER WHERE C_ID =" + id + " AND DRIVERS_LICENSE_NUM = " + lp);
