...
public class viewIndividualCustomer {
	
	public viewIndividualCustomer(){
        JFrame viewCustomer = new JFrame("View Individual Customer");
    ...
    private static void placeComponents(JPanel panel) {
	    ...
	    customerID.setBounds(280,10,100,25);
            ...
            JLabel licenseNumLabel = new JLabel("License Number of customer to be viewed: ");
	    ...
	    ViewcustomerButton.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
                            ...
                            if (command.equals("View Customer")){	
                                ...
                                ResultSet r = stmt.executeQuery("select * from INDIVIDUAL_CUSTOMER i,CUSTOMER c WHERE (i.c_id=" + id + " and i.drivers_license_num=" + lNum + " and c.customer_id=" + id + ");");
