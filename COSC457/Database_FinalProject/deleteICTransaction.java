...
public class deleteICTransaction {
    
    public deleteICTransaction(){
    ...
    private static void placeComponents(JPanel panel) {
	    ...
	    TransactionID.setBounds(280,10,100,25);
            ...
            JLabel DLNumLabel = new JLabel("Drivers License # of Transaction to be Deleted: ");
            DLNumLabel.setBounds(50, 50, 275, 25);
            panel.add(DLNumLabel);
             
            JTextField DriversLicenseNum = new JTextField(20);
            DriversLicenseNum.setBounds(280,50,100,25);
            panel.add(DriversLicenseNum);
            
	    
	    JButton DeleteTransactionButton = new JButton("Delete Transaction");
	    DeleteTransactionButton.setBounds(120, 90, 150, 25);
	    ...
	    DeleteTransactionButton.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
                            ...
                            if (command.equals("Delete Transaction")){	
                                ...
                                String dl = DriversLicenseNum.getText();
